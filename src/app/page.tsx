  ...
  return (
    <div className="flex flex-row items-center justify-center h-screen">
      ...
      <div className="flex flex-col items-start justify-center h-screen w-1/2 pl-[7%]">
        ...
        <Link href='/productList' className="w-[50%] h-[60px] bg-blue-500 rounded-[30px] mt-14 font-bold text-white flex items-center justify-center"><button>Get Started</button></Link>
      </div>
    </div>
  );
}
